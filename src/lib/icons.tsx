...
export const PaintBrushIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const WrenchScrewdriverIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.42 15.17l-5.7-2.85a1 1 0 01-.58-.9V5.59a1 1 0 011.447-.894l5.7 2.85a1 1 0 01.58.9v5.83a1 1 0 01-1.447.894zM12.58 15.17l5.7-2.85a1 1 0 00.58-.9V5.59a1 1 0 00-1.447-.894l-5.7 2.85a1 1 0 00-.58.9v5.83a1 1 0 001.447.894z" />
  </svg>
)

export const StarIcon = ({ className = "w-5 h-5", filled = false }: IconProps) => (
...
export const ExclamationCircleIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
